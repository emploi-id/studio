...
const careerAdviseData = [
    {
        title: "Cara Menulis Resume yang Menonjol",
        content: "Buat resume Anda ringkas, jelas, dan disesuaikan dengan pekerjaan yang Anda lamar. Gunakan kata kunci dari deskripsi pekerjaan. Tonjolkan pencapaian Anda dengan angka dan data. Minta orang lain untuk memeriksanya untuk menemukan kesalahan ketik."
    },
    {
        title: "Tips untuk Wawancara Kerja yang Sukses",
    ...
    <div className="container mx-auto max-w-4xl px-4 py-12">
      <div className="text-center">
        ...
        <p className="mt-4 max-w-2xl mx-auto text-lg text-muted-foreground">
          Temukan tips dan wawasan ahli untuk membantu Anda maju dalam karir Anda.
        </p>
      </div>
