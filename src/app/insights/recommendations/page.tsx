...
const mockUserData = {
  ...
  preferences: 'Saya mencari posisi jarak jauh penuh waktu di perusahaan dengan budaya rekayasa yang kuat. Saya tertarik pada sektor fintech dan AI. Ekspektasi gaji di atas $150.000.',
};
